...
from bridge_core.brain.routes import router as brain_router
...
from bridge_core.status.routes import router as status_router
from bridge_core.admin.routes import router as admin_router
